	...
	if(instantiated):
		...
		if _is_time_attack:
			if _ta_finished:
				return
			if (
				$Cadenas/Pieza0.correct and $Cadenas/Pieza1.correct and $Cadenas/Pieza2.correct and
				$Cadenas/Pieza3.correct and $Cadenas/Pieza4.correct and $Cadenas/Pieza5.correct and
				!ganoRonda
			):
				ganoRonda = true
