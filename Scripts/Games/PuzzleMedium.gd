...
var gano = false
var ganoRonda = false
var palabrasEsp = BancoPuzzle.palabrasEspMedium 
var cadenas = BancoPuzzle.cadenasMedium 
var cadenasOrdenadas = BancoPuzzle.cadenasOrdenadasMedium 
...
func _ready():
	...
	# 1) Configurar el tiempo de Medium
...
func _actualizar_puntajes(path):
	...
	if FileAccess.file_exists(path):
		...
		# No existe archivo: lo creo con medium lleno y easy/hard en 0
		is_new_record = true
		var content = {
			"easy": {
