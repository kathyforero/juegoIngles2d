...
func nuevaRonda():
	...
	# Letterboxes en orden de izquierda a derecha (5 letras)
	var letterboxes = [$Ordenada/Letterbox5, $Ordenada/Letterbox6, $Ordenada/Letterbox7, $Ordenada/Letterbox8, $Ordenada/Letterbox9]
